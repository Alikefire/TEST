...
if __name__ == '__main__':
    folder_path = '/home/xiexin/xx_help/LLaMA-Factory/data/open-r1/Mixture-of-Thoughts/mix_train_data/instruct'  # 文件夹路径
    # 示例：输出为JSONL格式
    output_file_jsonl = '/home/xiexin/xx_help/LLaMA-Factory/data/open-r1/Mixture-of-Thoughts/mix_train_data/instruct/all_domain_merged.jsonl'
