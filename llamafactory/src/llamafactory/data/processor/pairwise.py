...
class PairwiseDatasetProcessor(DatasetProcessor):
    ...
    def preprocess_dataset(self, examples: dict[str, list[Any]]) -> dict[str, list[Any]]:
        ...
        for i in range(len(examples["_prompt"])):
            ...
            model_inputs["chosen_position_ids"].append(list(range(len(chosen_input_ids))))#新增参数
            model_inputs["rejected_position_ids"].append(list(range(len(rejected_input_ids))))#新增参数
