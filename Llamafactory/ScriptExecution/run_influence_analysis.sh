...
# --------------------------
# 设置模型、数据集和保存路径
MODEL_PATH="/home/xiexin/xx_help/LLaMA-Factory/Model/OriginalModel/Qwen/Qwen3-0.6B-Base" # 替换为您的模型路径
...
SAVE_PATH="./influence_outputs/Qwen3-0.6B-mix_200" # 替换为您的结果保存路径
LOG_DIR="logs"                        # 日志存放目录
...
accelerate launch \
  /home/xiexin/xx_help/IDEAL-678C520/main.py \
