...
if __name__ == '__main__':
    domain_name="science"
    folder_name="12k-18k"
    folder_path = f'/inspire/hdd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/zhaoziyu-240108120122/xx_help/LLaMA-Factory/data/open-thoughts/OpenThoughts3-1.2M/data/instruct/{domain_name}/{folder_name}'  # 文件夹路径
    # 示例：输出为JSONL格式
    output_file_jsonl = f'/inspire/hdd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/zhaoziyu-240108120122/xx_help/LLaMA-Factory/data/open-thoughts/OpenThoughts3-1.2M/merge_data/instruct/{domain_name}/{folder_name}.jsonl'
